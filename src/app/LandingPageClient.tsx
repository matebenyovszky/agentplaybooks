    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            {["Claude Code", "Cursor", "Codex", "Antigravity", "Hermes", "Custom GPTs", "Gemini Gems", "Local LLMs", "Agent Skills", "SKILL.md", "AGENTS.md", "MCP Servers", "Cursor Rules", "Agent Memory"].map((tech) => (
              <span
                key={tech}
          ...
          >
            Open source and self-hostable. For software agents today, physical robots tomorrow. 🦉
          </motion.p>
        </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-b from-white to-blue-50/50 dark:from-transparent dark:to-blue-900/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-amber-700 dark:text-amber-300">Community Library</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            Browse public skills, personas, and MCP servers built by the community, and install
            any of them into your own playbook. For software agents today, physical robots tomorrow.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-transparent to-blue-50/50 dark:to-blue-950/20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose dark:prose-invert prose-lg max-w-none">
            ...
            >
              <p>
                <strong className="text-amber-600 dark:text-amber-400">AgentPlaybooks</strong> is a portable
                <strong> operating environment for AI agents</strong>. A playbook holds everything an agent needs
                to work — its <strong>persona</strong>, its <strong>skills</strong>, its <strong>MCP servers</strong>,
                its <strong>project instructions</strong>, and its <strong>memory</strong> — as one source of truth
                that belongs to you rather than to any single vendor.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="p-4 bg-white dark:bg-blue-950/30 rounded-xl border border-blue-100 dark:border-blue-800/30 shadow-sm dark:shadow-none">
                  ...
                  <ul className="text-sm space-y-1 text-neutral-600 dark:text-slate-400">
                    <li>• One set of instructions, every tool</li>
                    <li>• Agent Skills in SKILL.md format</li>
                    <li>• MCP servers, federated and proxied</li>
                    <li>• Memory and canvas that survive a session</li>
                  </ul>
                </div>
                <div className="p-4 bg-white dark:bg-blue-950/30 rounded-xl border border-blue-100 dark:border-blue-800/30 shadow-sm dark:shadow-none">
              ...
              <p>
                <strong>Open source</strong> and <strong>self-hostable</strong>, so the playbook is the portable
                source of truth — not any single vendor or editor. Switch platforms, run several at once, or host
                the whole thing yourself. Built for coding agents and AI assistants today, and for the physical
                robots that will need the same portable skills tomorrow.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-neutral-500 dark:text-slate-500">
                One playbook, every agent. Portable skills, tools, and memory for AI agents — and the robots that come next.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-neutral-500 dark:text-slate-500">
                <li><Link href="/explore" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">Explore Public Skills</Link></li>
