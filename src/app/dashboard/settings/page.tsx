                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      title="Rotate key and reveal the new value"
                      aria-label="Rotate key and reveal the new value"
                    >
            ...
            {createdKey ? (
              <>
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-white">New API Key Ready</h3>
