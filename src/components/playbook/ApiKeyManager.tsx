...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  viewer: ["memory:read", "canvas:read", "skills:read", "personas:read"],
  coworker: ["memory:read", "memory:write", "canvas:read", "canvas:write", "skills:read", "skills:write", "personas:read", "personas:write"],
  admin: ["full"],
};
