...
check(variants[2].logo === "assets/icon.svg", "Cursor plugin logo path differs.");
check(variants[4].plugins?.[0]?.logo === "packages/cli/assets/icon.svg", "Cursor marketplace logo path differs.");
